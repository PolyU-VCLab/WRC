...
class Dataset:
    def __init__(self, dataset_name, dataset_set, remove_hards, resize=None, dataroot="datasets"):
        ...
        if dataset_name == "VOC07":
            ...
            self.root_path = os.path.join(self.dataroot, f"{dataset_set}{self.year}")
            ...
            self.all_annfile = os.path.join(self.dataroot, "annotations/instances_train2014.json")
    ...
    def load_image(self, im_name):
        ...
        if "VOC" in self.dataset_name:
            ...
            image = skimage.io.imread(os.path.join(self.dataroot, f"train2014/{im_name}"))
        else:
